...
|---|-------|--------------------|-----------|------|
| 01 | [Audit validé contre le code réel](PHASE-01-audit.md) | Confronter l'audit au réel : migrations, tables, RLS, `shop_id`, `business_type`, plans, Wave, routes, frontend | — | ⬜ NON DÉMARRÉ |
